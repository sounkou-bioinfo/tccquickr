...
expect_true(grepl("entry: tccq2_entry", out_sum, fixed = TRUE))
expect_true(grepl("- x : double\\[NA\\]", out_sum))
expect_true(grepl("- y : double\\[NA\\]", out_sum))
expect_true(grepl("ir: program", out_sum, fixed = TRUE))
...
expect_true(grepl("ir: program", out_prog, fixed = TRUE))
expect_true(grepl("kernel: kernel_program -> fold", out_prog, fixed = TRUE))
expect_true(grepl("locals:", out_prog, fixed = TRUE))
expect_true(grepl("- y : double\\[NA\\]", out_prog))
expect_true(grepl("statements: 2 \\[bind, store_index\\]", out_prog))
