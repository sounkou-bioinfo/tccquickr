...
The next tightening is richer signatures and domain rules on implementations,
not another source whitelist.
...
the printers should not walk the raw value graph and rediscover expression
