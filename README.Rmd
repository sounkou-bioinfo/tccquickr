...
shape, parameter names, lowered parameter value ids, result value id, and the
length/index/accumulator names needed by generated loops. C, Rtinycc, and
Fortran consume that same interface before choosing whether the concrete source
uses a C return value, a Fortran function result, a Fortran output argument, or
a TinyCC FFI signature.
