...
- [ ] additional C backends beyond the current source-only and TinyCC-backed path
...
- [ ] backend expansion toward other C compilation/loading paths such as system compiler or `callme`-style workflows
