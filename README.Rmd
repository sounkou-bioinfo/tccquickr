...
- [ ] additional C backends beyond the current source-only, TinyCC-backed, and shared-library path

### Current architecture split

- [x] frontend: parse `declare(type(...))` and lower a small R subset
- [x] middle-end: validate IR, infer effects, kernelize, fuse, handle boundaries, and derive conservative plans
