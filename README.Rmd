...
The current target program is `tccq_apotheosis_kernel()`: a logistic-gradient
array kernel with symbolic shapes, reductions, normalization, matrix-vector
multiply, and scalar/vector fusion pressure. It fails today by design. Making
that program pass through a typed IR is the first serious milestone.
