...
dependencies from the function body for a very small subset; moving operation
resolution fully onto typed call and implementation records is one of the next
tightening passes.
...
fusion groups, and storage facts. This is not a general legality pass and it is
