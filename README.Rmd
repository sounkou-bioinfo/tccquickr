...
`TccqExpression` and `TccqBackendFunctionInterface` handoffs. The anvil-style
...
Those different families pressure the same typed representation from different
directions, reducing the chance that the IR is secretly reward-hacked for one
concrete backend.
