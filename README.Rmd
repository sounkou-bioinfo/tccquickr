...
storage facts. Each operation value carries one `TccqLoweredOperation` payload
that owns the shared `TccqOpSignature`, result-domain policy, selected
implementation, and optional reduction facts used to type the call. The
generated fusion group preserves operation signatures and domain policies, then
derives its target and effect from the resolved operations. Later fusion,
